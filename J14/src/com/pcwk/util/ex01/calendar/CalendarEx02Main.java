...
public class CalendarEx02Main implements LoggerManager {
	...
	public static void main(String[] args) {
		...
		// 초
		LOG.debug("초(0~60) : " + today.get(Calendar.SECOND));

		// 1000분의 1초
		LOG.debug("1000분의 1초 : " + today.get(Calendar.MILLISECOND));

		LOG.debug(
				today.get(Calendar.HOUR_OF_DAY) + ":" + today.get(Calendar.MINUTE) + ":" + today.get(Calendar.SECOND)); // 10:25:48
