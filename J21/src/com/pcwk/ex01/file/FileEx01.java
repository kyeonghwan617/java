...
public class FileEx01 {
	 ...
	 * @param dir
	 */
	public static void pringFileList(File dir) {
		System.out.println(dir.getAbsolutePath()+" 디렉토리");
		
		File[] files = dir.listFiles();//하부에 있는 파일과 디렉토리 목록
		
		//서브디렉토리 저장할 ArrayList : files 디렉토리 인덱스 저장
